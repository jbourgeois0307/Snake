...
void ConsoleWriter::push(std::string const & imageName)
{
	write(image(imageName));
}

void ConsoleWriter::push(std::string const & imageName1, std::string const & imageName2)
{
	image(imageName2) = image(imageName1);
}
